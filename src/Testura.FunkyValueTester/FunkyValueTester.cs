...
{
    public class FunkyValueTester
    {
        private readonly CombinationLogger _logger;
        private readonly ICombinationFactory _combinationFactory;

        public FunkyValueTester()
        {
            _combinationFactory = new CombinationFactory();
        }

        public FunkyValueTester(CombinationLogger combinationLogger = null, ICombinationFactory combinationFactory = null)
            : this()
        {
